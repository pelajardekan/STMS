...
<div class="flex-1 flex flex-col items-center justify-center px-4 md:px-8 py-8 w-full">
    <div class="bg-base-100 shadow-xl rounded-2xl p-8 w-full max-w-4xl mx-auto">
        <h1 class="text-2xl font-bold mb-6 text-center">Update Parameter</h1>
        ...
        <form method="POST" action="{{ route('parameters.update') }}?type={{ request()->query('type') }}&id={{ request()->query('id') }}" class="space-y-6" onsubmit="return validateForm()">
            @csrf
            @method('PUT')
            ...
            <div class="form-control">
                ...
                <input type="text" value="{{ ucfirst(request()->query('type')) }}" class="input input-bordered w-full" readonly>
            </div>

            <!-- Pricing Section -->
            <div id="pricing-section" @if(request()->query('type') !== 'pricing') class="hidden" @endif>
                <div class="card bg-base-200 p-6">
                    ...
                    <div class="form-control mb-4">
                        ...
                        <select name="pricing_type" id="pricing_type" class="select select-bordered w-full @error('pricing_type') select-error @enderror" onchange="updatePricingType()">
                            ...
                            <option value="booking" {{ old('pricing_type', $pricing->pricing_type ?? '') == 'booking' ? 'selected' : '' }}>Booking</option>
                            <option value="rental" {{ old('pricing_type', $pricing->pricing_type ?? '') == 'rental' ? 'selected' : '' }}>Rental</option>
                    </select>
                        @error('pricing_type')
                            <span class="label-text-alt text-error">{{ $message }}</span>
                        @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('base_hourly_rate', $pricing->base_hourly_rate ?? '') }}"
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('base_daily_rate', $pricing->base_daily_rate ?? '') }}"
                                    oninput="validateBaseRate(this)"
                                />
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('base_monthly_rate', $pricing->base_monthly_rate ?? '') }}"
                                    oninput="validateBaseRate(this)"
                                />
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('base_yearly_rate', $pricing->base_yearly_rate ?? '') }}"
                                    oninput="validateBaseRate(this)"
                                />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('daily_hours_threshold', $pricing->daily_hours_threshold ?? '') }}"
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('daily_discount_percentage', $pricing->daily_discount_percentage ?? '') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('educational_discount_percentage', $pricing->educational_discount_percentage ?? '') }}"
                                    oninput="validateDiscountPercentage(this)"
                                />
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('corporate_discount_percentage', $pricing->corporate_discount_percentage ?? '') }}"
                                    oninput="validateDiscountPercentage(this)"
                                />
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('student_discount_percentage', $pricing->student_discount_percentage ?? '') }}"
                                    oninput="validateDiscountPercentage(this)"
                                />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('minimum_booking_hours', $pricing->minimum_booking_hours ?? '') }}"
                            ...
                            <div class="form-control">
                                ...
                                <input
                                    ...
                                    value="{{ old('maximum_booking_hours', $pricing->maximum_booking_hours ?? '') }}"
                                    oninput="validateBookingHours(this)"
                                />
                    ...
                    <div id="rental-duration-section" class="hidden mb-6">
                        ...
                        <div class="form-control">
                            ...
                            <input
                                ...
                                value="{{ old('rental_duration_months', $pricing->rental_duration_months ?? '') }}"
                    ...
                    <div class="form-control">
                        ...
                        <textarea
                            ...
                            rows="3"
                        >{{ old('pricing_notes', $pricing->notes ?? '') }}</textarea>
                        @error('pricing_notes')
                            <span class="label-text-alt text-error">{{ $message }}</span>
                        @enderror
                </div>
            ...
            <!-- Service Section -->
            <div id="service-section" @if(request()->query('type') !== 'service') class="hidden" @endif>
                <div class="card bg-base-200 p-6">
                    <h2 class="text-xl font-semibold mb-4 flex items-center">
                        <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="form-control">
                        ...
                        <textarea
                            ...
                            rows="3"
                        >{{ old('service_description', $service->description ?? '') }}</textarea>
            ...
            <!-- Amenity Section -->
            <div id="amenity-section" @if(request()->query('type') !== 'amenity') class="hidden" @endif>
                <div class="card bg-base-200 p-6">
                    <h2 class="text-xl font-semibold mb-4 flex items-center">
                        <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="form-control mb-4">
                        ...
                        <input
                            ...
                            value="{{ old('amenity_name', $amenity->name ?? '') }}"
                    ...
                    <div class="form-control">
                        ...
                        <textarea
                            ...
                            rows="3"
                        >{{ old('amenity_description', $amenity->description ?? '') }}</textarea>
...
function validateForm() {
    const parameterType = '{{ request()->query("type") }}';
    let isValid = true;
