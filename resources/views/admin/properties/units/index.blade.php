...
@section('title', 'Units for ' . $property->name)
...
<div class="flex-1 flex flex-col px-4 md:px-8 py-8 w-full">
    <div class="bg-base-100 shadow-xl rounded-2xl p-8 w-full mx-auto">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-base-content">Units for {{ $property->name }}</h1>
                <p class="text-base-content/60 mt-1">Manage units for this property</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('properties.units.create', $property->property_id) }}" class="btn btn-primary">
                        ...
                        <tr class="hover:bg-base-200/50 transition-colors">
                            ...
                            <td>
                                <div class="flex justify-center gap-1">
                                    <a href="{{ route('properties.units.edit', [$property->property_id, $unit->unit_id]) }}" 
                            ...
                            <td colspan="8" class="text-center py-12">
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base-content/60">Get started by creating your first unit for this property.</p>
                                    </div>
                                    <a href="{{ route('properties.units.create', $property->property_id) }}" class="btn btn-primary">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
...
<script>
    ...
    document.getElementById('confirmDeleteUnitBtn').onclick = function() {
        ...
        form.method = 'POST';
        form.action = '{{ route("properties.units.destroy", [$property->property_id, ":unitId"]) }}'.replace(':unitId', deleteUnitId);
                ...
                visibleRows.sort((a, b) => {
                    ...
                    switch(sortValue) {
                        case 'name':
                            ...
                            break;
                        case 'type':
                            aValue = a.querySelector('td:nth-child(2) .badge')?.textContent || '';
                            bValue = b.querySelector('td:nth-child(2) .badge')?.textContent || '';
                            break;
                        case 'status':
