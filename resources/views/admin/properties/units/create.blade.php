...
@section('title', 'Add Unit for ' . $property->name)
...
<div class="flex-1 flex flex-col items-center justify-center px-4 md:px-8 py-8 w-full">
    <div class="bg-base-100 shadow-xl rounded-2xl p-8 w-full max-w-4xl mx-auto">
        ...
        <form action="{{ route('properties.units.store', $property->property_id) }}" method="POST" class="space-y-6" id="unitForm">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-control" id="customUnitTypeField" style="display: none;">
                    ...
                    <div class="relative">
                        <input type="text" name="custom_type" id="custom_type" placeholder="Enter custom unit type" 
            ...
            <!-- Status and Description Grid (2x2) -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Status -->
                <div class="form-control">
                    <label class="label">
            ...
            <!-- Leasing Type and Availability Grid (2x2) -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Leasing Type -->
                <div class="form-control">
                    <label class="label">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <a href="{{ route('properties.units.index', $property->property_id) }}" class="btn btn-outline w-full">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    ...
    function toggleCustomUnitType() {
        ...
        if (unitTypeSelect.value === 'custom') {
            ...
            document.getElementById('custom_type').value = ''; // Clear text input
        }
    }

    // Initialize custom unit type field on page load
