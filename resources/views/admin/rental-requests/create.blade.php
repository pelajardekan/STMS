...
<div class="flex-1 flex flex-col items-center justify-center px-4 md:px-8 py-8 w-full">
    <div class="bg-base-100 shadow-xl rounded-2xl p-8 w-full max-w-4xl mx-auto">
        <h1 class="text-2xl font-bold mb-6 text-center">Create Rental Request</h1>
        ...
        <form method="POST" action="{{ route('admin.rental-requests.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
                ...
                <div class="form-control">
                    ...
                    <div class="relative">
                        <input
                            ...
                            name="start_date"
                            id="start_date"
                            class="input input-bordered w-full pl-10 @error('start_date') input-error @enderror"
                ...
                <div class="form-control">
                    ...
                    <div class="relative">
                        <input
                            ...
                            name="end_date"
                            id="end_date"
                            class="input input-bordered w-full pl-10 @error('end_date') input-error @enderror"
                            value="{{ old('end_date') }}"
                            required
                            readonly
                        />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-control">
                    ...
                    <div class="relative">
                        <select name="duration_type" id="duration_type" class="select select-bordered w-full pl-10 @error('duration_type') select-error @enderror" required onchange="updateEndDate()">
            ...
            <div class="form-control">
                <label class="label">
                    <span class="label-text">Agreement File (Optional)</span>
                </label>
                <div class="relative">
                    <input
                        type="file"
