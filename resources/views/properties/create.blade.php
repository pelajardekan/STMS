...
<div class="flex-1 flex flex-col items-center justify-center px-4 md:px-8 py-8 w-full">
    <div class="bg-base-100 shadow-xl rounded-2xl p-8 w-full max-w-4xl mx-auto">
        <h1 class="text-2xl font-bold mb-6 text-center">Add Property</h1>
        ...
        <form method="POST" action="{{ route('properties.store') }}" class="space-y-6" id="propertyForm">
            @csrf
...
<script>
    ...
    function toggleCustomPropertyType() {
        ...
        if (typeSelect.value === 'custom') {
            ...
            customTypeInput.value = ''; // Clear custom type input
        }
    }
    ...
    function saveParameters() {
        ...
        // Store the parameters for later use when property is created
        ...
        showToast('Parameters configured successfully! They will be applied when you create the property.', 'success');
    }
