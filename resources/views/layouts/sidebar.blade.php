...
<body class="min-h-screen font-sans antialiased bg-base-300"
    ...
    <div class="flex h-screen">
            ...
            <div class="flex-1 px-2 py-4 overflow-y-auto sidebar-content">
                <nav class="space-y-2">
                    @if(auth()->user()->isAdmin())
                        ...
                        <a href="/admin/properties" class="btn btn-ghost w-full text-base-content hover:bg-base-200 h-12"
                           :class="sidebarExpanded ? 'justify-start items-center' : 'justify-center'">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                            <template x-if="sidebarExpanded"><span class="ml-3 text-left">Manage Properties & Units</span></template>
                        </a>
                        <a href="/admin/parameters" class="btn btn-ghost w-full text-base-content hover:bg-base-200 h-12"
                           :class="sidebarExpanded ? 'justify-start items-start' : 'justify-center'">
                            <svg class="w-5 h-5 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                            <template x-if="sidebarExpanded">
                                <span class="ml-3 flex flex-col text-left leading-tight">
                                    <span>Manage Property / Unit</span>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <!-- TOP NAVBAR -->
            <nav class="bg-base-300 border-b border-base-300 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <h1 class="text-2xl font-bold text-base-content">@yield('title', 'Dashboard')</h1>
                    </div>
                    <div class="flex items-center space-x-2">
                        <x-select :options="['Last 30 days', 'Last 7 days', 'Last 24 hours']" class="bg-base-200 border-base-300 text-base-content" />
                    </div>
                </div>
            </nav>
